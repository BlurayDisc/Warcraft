...
public class TheExpanse {
    ...
    public void initialize(final Stage primaryStage) {
        ...
        // load sound file
        loadSoundEffects("laser", getClass().getClassLoader().getResource("laser_2.mp3"));
    ...
    private void setupInput(Stage primaryStage) {
        ...
        // set up stats
        EventHandler<KeyEvent> changeWeapons = new EventHandler<KeyEvent>() {
			@Override
        ...
        // set up stats
        EventHandler<MouseEvent> showMouseMove = new EventHandler<MouseEvent>() {
            @Override
            public void handle(MouseEvent event) {
    ...
    private void addSprites(Atom b) { }
    ...
    private void addSpritesToBeRemoved(Sprite missile) { }
	private Scene getGameSurface() {return null;}
	private Group getSceneNodes() {return null;}
    private void loadSoundEffects(String string, URL resource) { }
	private void setGameSurface(Scene scene) { }
	private void setSceneNodes(Group group) { }
	private String getWindowTitle() {return null;}
	private List<Node> getAllSprites() {return null;}
	private void playSound(String string) { }
	private void addSprites(Sprite m1) { }
}